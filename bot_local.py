...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = "PRASNATAMA RAMADHAN",
            BATCH_ACADEMY = "QOPPA NIGHT ONLINE",
            GITHUB_REPO_LINK = "https://github.com/Prasramadhan"
        )
...
#         # TO DO: perform calculation
         ...
         cpc = (total_spent/total_conversion).round(decimals = 2)
